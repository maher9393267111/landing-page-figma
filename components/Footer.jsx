          ...
          <div className="grid relative z-10 py-12 grid-cols-1 lg:grid-cols-2 items-center  lg:items-center">
            <div className="px-12 pt-4 h-full">
              ...
              <div className="flex items-center">
                <img className=" w-[36px] h-[25px] md:w-[85px] md:h-[55px]" src="/UN.png" />
            ...
            <p className="sm:flex hidde  text-[34px]  items-center font-normal  text-[#191919]  xl:text-[65px]">
              ...
              <div className="flex items-center mx-2">
                <img
                  ...
                  src="/UN.png"
                />
                <span className="text-[#191919]  uppercase font-semibold">lmtd</span>   <span classNameName="mx-2">Potential</span>
              </div>
              {/* Potential */}
            </p>
            {/* <img className="sm:hidden w-[90%]" src="/assets/icon-ft.png" /> */}
            <button onClick={()=>{window.scrollTo(0, 0);}} className="bg-white self-end mt-4 p-4 rounded-full text-[#080852] shadow-lg text-lg flex items-center justify-center w-10 h-10">
              ↑
            </button>
          </div>
          <div className="flex flex-col-rever sm:flex-row flex-col justify-between">
            ...
            <div className="flex  flex-col-rever flex-col   gap-3">
              <div className="flex gap-8  sm:text-[40px]">
                <div>LinkedIn</div>
                <div>Instagram</div>
              </div>

              <span className="text-[18px]  font-thin sm:text-right">
                <Link classNameName=" !no-underline" href={'/privacy'}>

 Privacy
                </Link>
               <span classNameName="px-2">|</span>
